...
private:
    ...
    QPointer<NewDatabaseWizardPageGeneral> m_generalPage;
    QPointer<NewDatabaseWizardPageEncryption> m_encryptionPage;
    QPointer<QWizardPage> m_changeKeyPage;
    QPointer<ChangeMasterKeyWidget> m_changeKeyWidget;
};
