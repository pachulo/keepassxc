...
#include "gui/dbsettings/DatabaseSettingsWidgetChangeMasterKey.h"

NewDatabaseWizardPageMasterKey::NewDatabaseWizardPageMasterKey(QWidget* parent)
    : NewDatabaseWizardPage(parent)
{
    setPageWidget(new DatabaseSettingsWidgetChangeMasterKey());

    setTitle(tr("Database Master Key"));
    setSubTitle(tr("To secure your database, you need to set a master key which is only known to you."));
}
